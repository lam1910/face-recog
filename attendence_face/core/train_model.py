    ...
    def train_model(self, wr_out=False, file_name=None, 
        ...
        if self.method == 'svc':
            try:
                ...
                if final_res is None:
                    print('You have choosed not to write the model out')
                    return clf
        # if user choose the random forest model
            ...
            try:
                ...
                print('Arguments for RandomForest is not acceptable for sklearn. Contruct with default value')
                ...
                final_res = self.write_out_ctrl(wr_out, clf, file_name)
                if final_res is None:
                    print('You have choosed not to write the model out. Return the model now')
                    return clf
