...
from data import WiderFaceDetection, detection_collate, preproc, cfg_mnet_cpu, cfg_re50_cpu
from layers.modules import MultiBoxLossCPU
...
mkldnn.benchmark = True


optimizer = optim.SGD(net.parameters(), lr=initial_lr, momentum=momentum, weight_decay=weight_decay)
criterion = MultiBoxLossCPU(num_classes, 0.35, True, 0, True, 7, 0.35, False)
